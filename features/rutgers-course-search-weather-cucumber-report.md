# Rutgers Course Search and Weather Cucumber Tests

This file collects the full Cucumber acceptance test content for the `Rutgers Course Search and Weather` feature in one place for reporting purposes.
